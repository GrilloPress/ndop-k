...
function preferenceChecker() {
  ...
  var prefText = ( pref == "true"  ) ?  "<p>Your health data <strong>will</strong> be shared | <a href='" + PROTOTYPE_URL + "/D01-set-your-preference' onclick='history.go(-1); return false;'>Edit <span class='util-visuallyhidden'>your preference</span></a></p>" : "<p>Your health data <strong>will not</strong> be shared | <a href='" + PROTOTYPE_URL + "/D01-set-your-preference' onclick='history.go(-1); return false;'>Edit</a></p>";
